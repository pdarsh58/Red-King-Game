...
function Character:init(map)
    ...
    self.yOffset = 9
    self.map = map
    self.apperance = love.graphics.newImage('the_red_king.png')
    -- music
    self.sounds = {
        ['jump'] = love.audio.newSource('4.wav', 'static'),
        ['hit'] = love.audio.newSource('3.wav', 'static'),
        ['1'] = love.audio.newSource('1.wav', 'static')
    }
    self.structureworks = {}
